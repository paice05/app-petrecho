...
export function Config() {
  ...
  const blueStyle = () => {
    setCurrentColor(
      ...
      (nowTheme.COLORS.PRIMARY_BACK_GROUND_COLOR = "#80e9ff"),
      (nowTheme.COLORS.PRIMARY_CARD_COLOR = "#19274e")
    );
  };
  ...
  const purpleStyle = () => {
    setCurrentColor(
      ...
      (nowTheme.COLORS.PRIMARY_BACK_GROUND_COLOR = "#e0aaff"),
      (nowTheme.COLORS.PRIMARY_CARD_COLOR = "#9d4edd")
    );
  };
